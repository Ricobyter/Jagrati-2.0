          ...
          <div className='w-full lg:w-1/2 py-10 lg:py-16 px-6 lg:px-12'>
            ...
            <form>
              ...
              <div className='mt-5 relative'>
                <input type={showPass ? 'password' : 'string'} className='border border-gray-400 py-1 px-2 w-full rounded-sm' placeholder='Password' />
                <div>
                  <div className='text-xl absolute top-2 right-3 cursor-pointer'>
                    {
